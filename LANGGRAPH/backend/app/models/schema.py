# Centrally defined 163-parameter Company Intelligence schema
# Authoritatively derived from consolidation.xlsx columns.
...
def get_empty_company_record():
    record = {}
    for key in COMPANY_SCHEMA_KEYS:
        if key in ["incorporation_year", "office_count"]:
            record[key] = None
        else:
            record[key] = ""
    return record

# Definitive list of 118 target companies extracted from generate_118_companies.js
TARGET_118_COMPANIES = [
    ...
    "Wipro", "Paytm Money", "Hexagon", "INDmoney", "Tech Mahindra", 
    "Simplilearn", "BigBasket", "Ecom Express", "Kyndryl", "MobiKwik", 
    "Shadowfax", "Rupeek", "3i Infotech", "BharatPe", "HighRadius"
]
