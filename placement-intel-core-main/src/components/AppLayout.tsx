...
import NotificationPanel from '@/components/placement/NotificationPanel';
...
const navItems = [
  ...
  { path: '/risk-engine', label: 'Risk Engine', icon: ShieldAlert },
];
        ...
        <div className="flex items-center justify-between px-4 h-14 max-w-[1600px] mx-auto">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-foreground text-sm tracking-wide">
              PES <span className="text-primary">PlaceIntel</span>
            </span>
          </Link>
